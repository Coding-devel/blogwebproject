<nav class="navbar navbar-expand-lg navbar-dark Primary-background">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
          <a class="nav-link able" href="loginpage.jsp"><span class="fa fa-user-circle "></span> Login</a>
      </li>
        <li class="nav-item">
          <a class="nav-link able" href="Registrationpage.jsp"><span class="fa fa-user "></span> Sign up</a>
      </li>
    </ul>
